...
- **Big Five profile** (O/C/E/A/N each rated High/Mid/Low)
- **Enneagram affinity** (primary type)
- **Default cognitive bias** (1–2 biases most likely to emerge)
- **Weakness**
...
- Enneagram affinity: 5 (Investigator) or 1 (Perfectionist)
...
- Enneagram affinity: 7 (Enthusiast) or 8 (Challenger)
...
- Enneagram affinity: 4 (Individualist) or 9 (Peacemaker)
...
- Enneagram affinity: 3 (Achiever) or 8 (Challenger)
...
- Enneagram affinity: 9 (Peacemaker) or 2 (Helper)
...
- Big Five: O-High, C-High, E-Low, A-Low, N-Low
- Enneagram affinity: 5 (Investigator)
...
- Enneagram affinity: 1 (Perfectionist) or 6 (Loyalist)
...
- Enneagram affinity: 7 (Enthusiast) or 2 (Helper)
...
- Enneagram affinity: 5 (Investigator) or 8 (Challenger)
...
- Enneagram affinity: 2 (Helper) or 6 (Loyalist)
...
- Enneagram affinity: 2 (Helper) or 3 (Achiever)
...
- Enneagram affinity: 6 (Loyalist) or 9 (Peacemaker)
...
- Enneagram affinity: 8 (Challenger) or 7 (Enthusiast)
- Default bias: Overconfidence bias; Neglect of probability (discounts low-probability risks)
- Weakness: Prefers improvisation over long-term, systematic thinking.
...
- At least one Judging (J) type and one Perceiving (P) type.
- At least one Extrovert (E) and one Introvert (I).
...
| Trait | High | Low |
|-------|------|-----|
| **O** Openness | Embraces abstraction, hypotheticals, novel ideas | Prefers concrete, established, proven approaches |
| **C** Conscientiousness | Systematic, evidence-driven, consistent | Flexible, improvisational, comfortable with ambiguity |
| **E** Extraversion | Speaks often, leads the room, processes externally | Speaks less but more deeply, processes before speaking |
...
| Type | Name | Core drive | Debate tendency |
|------|------|-----------|----------------|
| 1 | Perfectionist | Doing the right thing | Defends correctness; defensive when criticized |
| 2 | Helper | Being needed | Prioritizes others' needs; withholds own position |
| 3 | Achiever | Success and recognition | Treats debate as performance; tracks who is "winning" |
| 4 | Individualist | Being authentic and unique | Withdraws if misunderstood; brings emotional depth |
| 5 | Investigator | Knowledge and competence | Detaches from emotion; prioritizes data collection |
| 6 | Loyalist | Security and consistency | Defers to authority; struggles with uncertainty |
| 7 | Enthusiast | Freedom and possibility | Generates options; avoids convergence |
...
| Bias | Pattern | Facilitator counter-prompt |
|------|---------|---------------------------|
| Confirmation bias | Only citing supporting evidence | "What evidence would challenge your position?" |
| Anchoring | Locked to the first number or frame introduced | "If we started from a different reference point, what changes?" |
| Authority bias | Over-relying on expert opinion or data | "What if that source is wrong? What's the underlying reasoning?" |
| Sunk cost fallacy | Defending a position because of prior investment | "If you were deciding this fresh today, what would you choose?" |
| Bandwagon effect | Drifting toward the majority view | "Who holds the position that no one else does?" |
| Dunning-Kruger effect | High confidence in a low-knowledge area | "What would an expert in this area say you're missing?" |
| Framing effect | Judgment shifts based on how the issue is worded | "How would the opposing side describe the same situation?" |
| Availability heuristic | Vivid stories outweigh base rates | "Is this representative, or is it a memorable exception?" |
| Loss aversion | Threats weighted more than equivalent gains | "What's the cost of not acting, not just the cost of acting?" |
| Status quo bias | Defaults to current state as safe | "What does staying the same actually cost over time?" |
| Present bias | Underweights future consequences | "How does this look in ten years?" |
| Optimism bias | Underestimates obstacles and risks | "What's the most likely way this fails?" |
